        ...
        <ul class="pagination pagination-sm pull-right" >
         <li [class.no-active]="true">
              <a style="padding:0px;margin:0px; ">
               <div style="width:81px;height:25px; border:none; text-align: center;padding-top:5px;margin:0px;" >Registros: {{totalRecords}}</div>
             </a>
            </li>
           <li >
             <a  style="padding:0px;margin:0px;width:79px; ">
             <span style="padding-left:5px;padding-right:3px;" > Exibir:</span><input  [(ngModel)]="numberOfRecordsPage" (ngModelChange)="loadData(true)" style="width:31px; height:25px; border:none; text-align: center;padding:0px;margin:0px;" type="number" min="1" max="{{totalRecords}}"  name="aero-page"  value="" />  
             </a>
            </li>
            <li  [class.no-active]="activePage==1"><a   (click)="goToNextRecords('first')" >«</a></li>
            <li  [class.no-active]="activePage==1"  ><a  (click)="goToNextRecords('prev')" >‹</a></li>
            <li [class.no-active]="true" >
             <a style="padding:0px;margin:0px; ">
               <div style="width:37px;height:25px; border:none; text-align: center;padding-top:5px;margin:0px;" >{{activePage}}/{{totalPages}}</div>
             </a>
            </li>
            <li  [class.no-active]="activePage==totalPages" ><a  (click)="goToNextRecords('next')"  >›</a></li>
            <li [class.no-active]="activePage==totalPages"><a   (click)="goToNextRecords('last')"   >»</a></li>
            <li>
             <a style="padding:0px;margin:0px;">
               <span style="padding-left:3px;padding-right:2px;">Página: </span><select  [(ngModel)]="pageSelected"  (ngModelChange)="goToNextRecords('page')" style="width:51px; height:25px; border:none; text-align: center;padding:0px;margin:0px;" type="text" name="aero-page" >
